...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-2.2.29.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="2.2.x@r9914189f972103907c24377a1567897e68642920; 2017-10-05 13:01:04+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-2.2.29.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
