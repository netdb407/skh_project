...
if [ -z "$JAVA_OPTS_SCRIPT" ] ; then
    JAVA_OPTS_SCRIPT="-Djna.nosys=true -XX:+HeapDumpOnOutOfMemoryError -XX:MaxDirectMemorySize=1024g -Djava.awt.headless=true -Dfile.encoding=UTF8 -Drhino.opt.level=9"
fi
...
exec "$JAVA" -d64 $JAVA_OPTS \
    ...
    -Dorientdb.build.number="2.2.x@r9914189f972103907c24377a1567897e68642920; 2017-10-05 13:01:04+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.29.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
